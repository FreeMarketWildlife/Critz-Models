...
const weapons = [
  ...
  normalizeWeapon({
    ...
    special: {
      perk: 'Holding the draw for 1.5s adds +12 damage and a guidance shimmer for allies.',
    },
  }),
  normalizeWeapon({
    id: 'crossbow',
    ...
    stats: {
      damage: 28,
      fireRate: '35 rpm (Lever)',
      reloadSpeed: '1.6 s',
      magazineSize: '1 bolt',
      capacity: '12 reserve',
      recoil: 60,
      range: '90 m',
      projectileVelocity: '100 m/s',
      weight: '7 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    stats: {
      damage: 20,
      fireRate: '50 rpm (Volley)',
      heatCapacity: '100 heat',
      heatDissipation: '30 heat/s',
      recoil: 5,
      range: '45 m',
  ...
  normalizeWeapon({
    ...
    stats: {
      damage: 5,
      fireRate: '25 rpm (Manual)',
      drawSpeed: '0.4 s',
      reloadSpeed: '0.2 s',
      capacity: '20 stones',
      recoil: 5,
      range: '20 m',
      projectileVelocity: '50 m/s',
      weight: '2 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    stats: {
      damage: 12,
      fireRate: '90 rpm (Beam)',
      heatCapacity: '70 heat',
      heatDissipation: '25 heat/s',
      recoil: 10,
      range: '26 m',
      statusEffect: '25% slow',
      effectDuration: '2.5 s',
      weight: '1.5 pts',
    },
    special: {
      perk: 'Every third bolt grants nearby allies +12 stamina bloom.',
    },
  }),
  normalizeWeapon({
    id: 'flamethrower',
    ...
    stats: {
      damage: 8,
      dotDamage: '15 /s',
      fireRate: '120 rpm (Stream)',
      magazineSize: '50 fuel',
      reloadSpeed: '2.5 s',
      recoil: 30,
      range: '10 m',
      igniteDuration: '3.5 s',
      weight: '8 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Grapple: Leap and bind a foe for 1.2s, dealing 10 bonus damage.',
      perk: 'Grappled targets cannot swing and grant you 15% damage resist.',
    },
  }),
  normalizeWeapon({
    id: 'knife',
    ...
    special: {
      ability: 'Backstab: Striking from behind deals 75 damage and silences for 1s.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Returning Throw: Toss up to 16 m for 45 damage and recall automatically.',
      perk: 'Thrown strikes mark targets so allies deal +12% damage for 4s.',
    },
  }),
  normalizeWeapon({
    id: 'katana',
    ...
    special: {
      ability: 'Wind Deflect: Reflect projectiles for 1s then counter-cut for 20 bonus damage.',
      perk: 'Successful deflect restores 15 stamina to nearby allies.',
    },
  }),
  normalizeWeapon({
    id: 'shield',
    ...
    special: {
      ability: 'Shield Bash: Lunge forward, knocking enemies back 4 m and dealing 24 damage while stunning 0.6s.',
      perk: 'Holding guard grants allies behind you 8% damage reduction.',
    },
  }),
  normalizeWeapon({
    id: 'warhammer',
    ...
    special: {
      ...
      perk: 'Impact zone grants allies +15 stamina over 3s.',
    },
  }),
  normalizeWeapon({
    id: 'bo-staff',
  ...
  normalizeWeapon({
    ...
    special: {
      perk: "Smoke extinguishes flames and shields Bottle o' Gas from ignition for 4s.",
    },
  }),
  normalizeWeapon({
    id: 'resource-pack',
    ...
    special: {
      perk: 'Opening grants 20 stamina to teammates.',
    },
  }),
  normalizeWeapon({
    id: 'mines',
  ...
  normalizeWeapon({
    ...
    special: {
      perk: "Ignite with allied flames to create enemy-only fire for 30 damage per second.",
    },
  }),
  normalizeWeapon({
    id: 'bottle-fire',
  ...
  normalizeWeapon({
    ...
    special: {
      perk: 'Paralyzed enemies take +12% ranged damage from your squad.',
    },
  }),
  normalizeWeapon({
    id: 'bottle-ice',
    ...
    special: {
      perk: 'Allies sliding gain +15% speed; enemies skid without control.',
    },
  }),
  normalizeWeapon({
    id: 'bottle-air',
    ...
    special: {
      perk: 'Self-knockback refunds 15 stamina and never harms friends.',
    },
  }),
];
