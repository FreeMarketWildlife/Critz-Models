...
const weapons = [
  normalizeWeapon({
    ...
    stats: {
      ...
      capacity: '120 reserve',
      recoil: 100,
      range: '45 m',
      projectileVelocity: '700 m/s',
      weight: '7 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    special: {
      perk: 'Holding the draw for 1.5s adds +5 damage and a guidance shimmer for allies.',
    },
  }),
  normalizeWeapon({
    id: 'crossbow',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Grapple: Leap and bind a foe for 1.5s, dealing 10 bonus damage.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Backstab: Striking from behind deals 30 damage and silences for 1s.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Returning Throw: Toss up to 18 m for 24 damage and recall automatically.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Wind Deflect: Reflect projectiles for 1s then counter-cut for 18 bonus damage.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Starfall Slam: Crash down for 36 AoE damage and launch foes skyward.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Cyclone Spin: Deflect bolts, deal 14 damage, push foes 3 m, and propel yourself 4 m back.',
