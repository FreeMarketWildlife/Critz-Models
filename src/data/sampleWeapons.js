...
const weapons = [
  normalizeWeapon({
    ...
    stats: {
      ...
      capacity: '150 reserve',
      range: '55 m',
      projectileVelocity: '820 m/s',
      recoil: '100 (High)',
      weight: '8 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    special: {
      perk: 'Holding the draw for 1.5s adds +10 damage and a guidance shimmer for allies.',
    },
  }),
  normalizeWeapon({
    id: 'crossbow',
  ...
  normalizeWeapon({
    ...
    stats: {
      damage: 20,
      fireRate: '50 rpm (Pulse)',
      heatCapacity: '100 heat',
      heatDissipation: '30 /s',
      range: '45 m',
      projectileType: 'Arcane bursts',
      recoil: '5 (Arcane Push)',
      weight: '10 pts',
    },
    special: {
  ...
  normalizeWeapon({
    ...
    stats: {
      ...
      heatCapacity: '85 heat',
      heatDissipation: '25 /s',
      range: '30 m',
  ...
  normalizeWeapon({
    ...
    stats: {
      damage: 12,
      fireRate: '90 rpm (Channel)',
      heatCapacity: '60 heat',
      heatDissipation: '22 /s',
      range: '24 m',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Grapple: Leap and bind a foe for 1.5s, dealing 15 bonus damage.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Backstab: Striking from behind deals 60 damage and silences for 1s.',
  ...
  normalizeWeapon({
    ...
    special: {
      ability: 'Returning Throw: Toss up to 18 m for 45 damage and recall automatically.',
  ...
  normalizeWeapon({
    ...
    special: {
      perk: "Ignite with allied flames to create enemy-only fire for 20 damage per second.",
    },
  }),
  normalizeWeapon({
    id: 'bottle-fire',
