...
export class WeaponDisplayApp {
  ...
  init() {
    ...
    if (defaultCritter) {
      ...
      this.activeAnimationId = this.getInitialAnimationId(defaultCritter);
  ...
  registerEventHandlers() {
    ...
    this.eventBus.on('critter:selected', (critterId) => {
      ...
      this.activeAnimationId = this.getInitialAnimationId(critter);
