...
export class WeaponDisplayApp {
  ...
  init() {
    ...
    this.activeAnimationId = null;
    this.critterSelector.render(null, { autoSelect: false });
  }
    ...
    this.root.innerHTML = `
      <div class="app-shell">
        ...
        <nav class="hud-nav" aria-label="Interface options">
          <details class="nav-section nav-section--critters" data-collapsible>
            <summary class="nav-section__summary">Critters</summary>
            <div class="nav-section__content" data-scroll="nav-section">
              <div data-component="critter-selector"></div>
            </div>
          </details>
          <details class="nav-section nav-section--categories" data-collapsible>
            <summary class="nav-section__summary">Weapons &amp; Tools</summary>
            <div class="nav-section__content" data-scroll="nav-section">
              <ul class="nav-tabs" data-component="nav-tabs"></ul>
            </div>
          </details>
          <details class="nav-section nav-section--maps" data-collapsible>
            <summary class="nav-section__summary">Maps</summary>
            <div class="nav-section__content" data-scroll="nav-section">
              ${mapsMarkup}
            </div>
          </details>
          <details class="nav-section nav-section--modes" data-collapsible>
      ...
      <ul class="nav-list">
        ${items
          .map(
            (item) => `
          <li>
            <details class="nav-subsection nav-item">
              <summary class="nav-item__summary">${item.label ?? item.name}</summary>
              <div class="nav-item__content" data-scroll="nav-subsection">
                <p class="nav-empty">Details are coming soon.</p>
              </div>
            </details>
          </li>
        `
