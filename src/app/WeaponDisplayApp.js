      ...
      <div class="app-shell">
        <div class="hud-brand">
          <div class="brand-text">
            <span class="brand-name">Critz</span>
            <span class="brand-subtitle">Arcane Arsenal</span>
          </div>
        </div>
